            ...
            <div class="page-header">
                <div class="add-item d-flex">
                    <div class="page-title">
                        <h4>Type Prduct</h4>
                        <h6>Manage your type product</h6>
                    </div>
                </div>
                ...
                <div class="page-btn">
                    <a href="#" class="btn btn-added" data-bs-toggle="modal" data-bs-target="#add-type"><i
                ...
                <div class="page-wrapper-new p-0">
                    <div class="content">
                        ...
                        <div class="modal-body custom-modal-body">
                            <form action="categoires" method="POST">
                                <div class="mb-3">
                        ...
                        <div class="modal-body custom-modal-body">
                            <form action="categories">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="categories" value="Laptop">
                                </div>
                                <div class="mb-3">
                                    <label class="form-label">Status</label>
                                    <select class="select form-control" name="status">
